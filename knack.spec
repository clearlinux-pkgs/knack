...
Source0  : https://github.com/microsoft/knack/archive/v0.8.1/knack-0.8.1.tar.gz
...
%prep
%setup -q -n knack-0.8.1
cd %{_builddir}/knack-0.8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618014902
...
cp %{_builddir}/knack-0.8.1/LICENSE %{buildroot}/usr/share/package-licenses/knack/eee5b07a657266ef6c5c20acee6685ac6732cd19
