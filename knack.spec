...
Version  : 0.11.0
Release  : 24
URL      : https://github.com/microsoft/knack/archive/v0.11.0/knack-0.11.0.tar.gz
Source0  : https://github.com/microsoft/knack/archive/v0.11.0/knack-0.11.0.tar.gz
...
%prep
%setup -q -n knack-0.11.0
cd %{_builddir}/knack-0.11.0
pushd ..
cp -a knack-0.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720045993
