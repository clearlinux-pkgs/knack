...
Version  : 0.8.0
Release  : 8
URL      : https://github.com/microsoft/knack/archive/v0.8.0/knack-0.8.0.tar.gz
Source0  : https://github.com/microsoft/knack/archive/v0.8.0/knack-0.8.0.tar.gz
...
%prep
%setup -q -n knack-0.8.0
cd %{_builddir}/knack-0.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617128087
...
cp %{_builddir}/knack-0.8.0/LICENSE %{buildroot}/usr/share/package-licenses/knack/eee5b07a657266ef6c5c20acee6685ac6732cd19
